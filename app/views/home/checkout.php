                                  ...
                                  <div class="col-md-8 order-md mb-5">
                                    ...
                                    <ul class="list-group mb-3">
                                      <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                          <h6 class="">Produk</h6>
                                          <input type="hidden" name="idbuku" value="<?= $_POST['idbuku']; ?>">
                                          <small class="text-muted" id="namaBuku" name=""><?= $_POST['namaBuku'];?></small>
                                          <input type="hidden" name="namaBuku" value="<?= $_POST['namaBuku']; ?>">
                                        </div>
                                        <span class="text-muted" id="hargaBuku" >Rp. <?= $harga_total = $_POST['hargaBuku'] * $_POST['jml_item'];?></span>
                                        <input type="hidden" name="harga_total" value="<?= $harga_total = $_POST['hargaBuku'] * $_POST['jml_item']; ?>">
                                    ...
                                    <form class="needs-validation" novalidate>
                                      <div class="row">
                                        <div class="col-12 mt-2">
                                          ...
                                          <input type="text" class="form-control" id="nama_penerima" name="nama_penerima" placeholder="Masukkan Nama">
                                        ...
                                        <div class="col-12 mt-2">
                                          ...
                                          <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan jalan" required>
                                          <div class="invalid-feedback">
